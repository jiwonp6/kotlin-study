package ch06_null_safety.ex

/*
    <사용자 도시 정보 입력 받기>
    사용자로부터 도시 이름을 입력받고, 해당 도시의 인구를 출력하는 프로그램을 작성하세요.
    사용자가 아무 것도 입력하지 않거나 공백만 입력한 경우, "알 수 없는 도시"라고 출력하고 프로그램을 종료하세요.
...
fun main() {
    ...
    val population = cityPopulation[city] ?: "인구 정보 없음"
    println("${city}의 인구는 ${population}명입니다.")
